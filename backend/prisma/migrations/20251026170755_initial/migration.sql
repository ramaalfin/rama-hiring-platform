...
CREATE TABLE "Job" (
    ...
    "numberOfCandidateNeeded" INTEGER NOT NULL,
    "minimumSalary" TEXT NOT NULL,
    "maximumSalary" TEXT NOT NULL,
    "minimumProfileInformationRequired" JSONB NOT NULL,
